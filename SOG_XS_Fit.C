...
Int_t showgaus = 0;
Int_t fitvars = 2;                       //0 = fit only Qi, 1 = fit R[i] and Qi, 2 = Fit R[i], Qi, and gamma.
...
if(fitvars == 0)
   {
     ...
     */
     ...
     //fxs0->SetParLimits(0,0.1,0.1);
     /*
     fxs0->SetParLimits(0,0.,1.);
     fxs0->SetParLimits(1,0.,1.);
     fxs0->SetParLimits(2,0.,1.);
     fxs0->SetParLimits(3,0.,1.);
     fxs0->SetParLimits(4,0.,1.);
     fxs0->SetParLimits(5,0.,1.);
     fxs0->SetParLimits(6,0.,1.);
     fxs0->SetParLimits(7,0.,1.);
     fxs0->SetParLimits(8,0.,1.);
     fxs0->SetParLimits(9,0.,1.);
     fxs0->SetParLimits(10,0.,1.);
     fxs0->SetParLimits(11,0.,1.);
     */
     //Starting Qim values.
     for(Int_t i=0;i<ngaus;i++)
       {
     ...
     */
     ...
     /*
     fxs0->SetParLimits(ngaus,0.,1.);
     fxs0->SetParLimits(ngaus+1,0.,1.);
     fxs0->SetParLimits(ngaus+2,0.,1.);
     fxs0->SetParLimits(ngaus+3,0.,1.);
     fxs0->SetParLimits(ngaus+4,0.,1.);
     fxs0->SetParLimits(ngaus+5,0.,1.);
     fxs0->SetParLimits(ngaus+6,0.,1.);
     fxs0->SetParLimits(ngaus+7,0.,1.);
     fxs0->SetParLimits(ngaus+8,0.,1.);
     fxs0->SetParLimits(ngaus+9,0.,1.);
     fxs0->SetParLimits(ngaus+10,0.,1.);
     fxs0->SetParLimits(ngaus+11,0.,1.);
     */
     cout<<"Yo5"<<endl;
